...
DB_PATH = Path(os.getenv("VECTRA_QUANT_DB", ROOT / "data" / "vectra_quant.db"))
...
class BacktestRun(Base):
    """One backtest job — submitted, tracked, and its result kept for history."""
    ...
    wiggle_test: Mapped[bool] = mapped_column(Boolean, default=True)
