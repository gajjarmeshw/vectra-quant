...
from sentinel.core.sizing import select_strike, size_with_cap
from sentinel.db import Suggestion, Trade, session, utcnow
from sentinel.llm.schema import implied_rr
...
class Lifecycle:
    ...
    def _cancel_own_stops_for(self, trade) -> None:
        """Cancel only the stop SENTINEL rested for this trade. Yours is left alone."""
